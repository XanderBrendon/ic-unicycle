    ...
    case 'blackholeNotController': {
      ...
      return {
        message:
          ...
          'controllers, and the canister doesn\'t belong to any SNS you track. Either run this from the ' +
          "canister's controlling identity, or track its SNS first — then try again.",
